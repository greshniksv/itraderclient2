...
namespace OpenNETCF.IO.Serial.GPS
{
	...
	public class Misc // utility functions
	{
		...
		public static int DecimalDegreesToIntPacked(decimal decim)
		{
			return (int)Math.Round(decim * 100000, 5);
		}

		public static decimal IntPackedToDecimalDegrees(int packed)
		{
			return (decimal)(packed / 100000f);
		}
